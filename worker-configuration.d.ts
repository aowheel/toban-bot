/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: d947ff0c5e79716d67cac64cd447dc73)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		GOLDSKY_WEBHOOK_SECRET: string;
		HATS_GRAPHQL_ENDPOINT: string;
		TOBAN_GRAPHQL_ENDPOINT: string;
		DISCORD_APPLICATION_ID: string;
		DISCORD_PUBLIC_KEY: string;
		DISCORD_BOT_TOKEN: string;
		toban_bot: D1Database;
	}
}
